...
do OWASP Top 10, usada no **Encontro 01** do curso _Segurança e Automação para Rails_.
...
_Desenvolvido para o curso Segurança e Automação para Rails — Encontro 01_
